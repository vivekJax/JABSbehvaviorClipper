...
ANNOTATIONS_DIR = '../jabs/annotations'  # Parent directory
VIDEO_DIR = '..'  # Parent directory where videos are located
    ...
    for json_path in json_files:
        try:
            ...
            if not labels:
                ...
                logging.warning(f"unfragmented_labels not found in {os.path.basename(json_path)}, using labels instead")
