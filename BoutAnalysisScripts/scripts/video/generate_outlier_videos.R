...
tryCatch({ options(editor = "vim") }, error = function(e) { tryCatch({ options(editor = NULL) }, error = function(e2) BoutAnalysisScripts/scripts/video/generate_outlier_videos.R) })
# Fix R environment issues
options(editor = NULL)
